...
ifeq ($(config),debug_x64)
  tetris_project_config = debug_x64
  raylib_config = debug_x64
endif
ifeq ($(config),debug_x86)
  tetris_project_config = debug_x86
  raylib_config = debug_x86
endif
ifeq ($(config),debug_arm64)
  tetris_project_config = debug_arm64
  raylib_config = debug_arm64
endif
ifeq ($(config),release_x64)
  tetris_project_config = release_x64
  raylib_config = release_x64
endif
ifeq ($(config),release_x86)
  tetris_project_config = release_x86
  raylib_config = release_x86
endif
ifeq ($(config),release_arm64)
  tetris_project_config = release_arm64
  raylib_config = release_arm64
endif
ifeq ($(config),debug_rgfw_x64)
  tetris_project_config = debug_rgfw_x64
  raylib_config = debug_rgfw_x64
endif
ifeq ($(config),debug_rgfw_x86)
  tetris_project_config = debug_rgfw_x86
  raylib_config = debug_rgfw_x86
endif
ifeq ($(config),debug_rgfw_arm64)
  tetris_project_config = debug_rgfw_arm64
  raylib_config = debug_rgfw_arm64
endif
ifeq ($(config),release_rgfw_x64)
  tetris_project_config = release_rgfw_x64
  raylib_config = release_rgfw_x64
endif
ifeq ($(config),release_rgfw_x86)
  tetris_project_config = release_rgfw_x86
  raylib_config = release_rgfw_x86
endif
ifeq ($(config),release_rgfw_arm64)
  tetris_project_config = release_rgfw_arm64
  raylib_config = release_rgfw_arm64
endif

PROJECTS := tetris-project raylib

.PHONY: all clean help $(PROJECTS) 

all: $(PROJECTS)

tetris-project: raylib
ifneq (,$(tetris_project_config))
	@echo "==== Building tetris-project ($(tetris_project_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f tetris-project.make config=$(tetris_project_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f tetris-project.make clean
